...
self.addEventListener('fetch', e => {
  ...
  // Static assets + optimized images -> stale-while-revalidate (fast, but self-heals so it never gets stuck stale)
  if (url.pathname.startsWith('/assets/') || url.pathname.startsWith('/img/') || url.pathname.startsWith('/.netlify/images')) {
    e.respondWith(
